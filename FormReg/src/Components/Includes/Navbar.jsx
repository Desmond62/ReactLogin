...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <nav style={{padding:'0px',boxShadow:'2px 2px 2px lightgrey'}} class="navbar-light bg-light sticky-top">
  <div class="container">
...
<div class="offcanvas offcanvas-start tog" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
